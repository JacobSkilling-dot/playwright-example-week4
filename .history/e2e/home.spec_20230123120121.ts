...
test.describe('Check About page navigation to the home page test ', () => {
    test('should navigate to the home page from the about us page', async ({ page }) => {
        await page.goto(aboutPage);

        await page.goto('text=Go Back');
